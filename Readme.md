...
Through a chat with the AI powered by LLM (chatGPT), users can explore datasets by generating visualizations or panning, zoomming the map.
...
사용자는 LLM 기반의 AI와 채팅을 하면서, 지도를 조작하거나, 차트를 생성하는 등의 탐색을 할 수 있습니다.
